...
/**
 * CodecMTF (encoder - decoder).
 * 
 * Brief:
 * - Class defines static methods to encode / decode any string given in StringL class using MTF method
 ...
 * 
 * Memory usage:
 * θ((sizeof(inputStr)) + θ(inputStr.size() * 4) + O(1)
 * 
 */
